...
@ApplicationScoped
public class FirmarDocumentoDelegadoFacadeImpl implements FirmarDocumentoDelegadoFacade {
    ...
    @Override
    public void execute(FirmarDocumentoDelegadoCommand command) {
        TareaFirma tareaFirma = tareaFirmaDao.findById(command.getIdTarea());
        tareaService.firmarTareaDelegado(tareaFirma, command.getFirma());
    }
