...
@Entity
public class RechazoSustituto extends PanacheEntityBase {

    private Long id;
    private DocumentoRechazado documentoRechazado;
    private Usuario usuario;

    protected RechazoSustituto() {
    }

    public RechazoSustituto(DocumentoRechazado documentoRechazado, Usuario usuario) {
